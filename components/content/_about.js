const title = 'About - HackYourFuture'
let content = `
# What is HackYourFuture?
HackYourFuture is a non-profit organisation that aims to train refugees, asylum seekers and other disadvantaged groups to become web-developers and empower them by opening the doors to a very in-demand job market.

In our 32-week program we train students with and without a coding background in modern JavaScript software development. Our aim is to have our students land their first software development job after finishing our course. Our teachers are all volunteers and extremely passionate about coding and sharing their expertise - we love it!

We believe talented newcomers in Denmark are a great opportunity for society and we are here to give them a helping hand to fulfill their potential.
...
Here we see an enormous opportunity for a win-win situation. By training newcomers in web-development we increase their chances of employment significantly and at the same time increase the amount of developers on the job market and further integration.
...
HackYourFuture is not about one or a handful of people, but about a community of developers who take the responsibility to share their knowledge and passion to people who need it most. There’s no room for ego. We teach because we love programming, and we teach because we care about others.
...
Our target audience is talented people who have significantly less opportunities to succeed in a professional setting than the majority of society.
...
We're always happy for more help and smart partnerships. Send us a message using the form below and describe how you imagine you could help our cause! We'll take it from there.


Developer? Become a mentor - write us a message first though, so we can figure out what would make most sense for you to do.  

Not a developer? We can always use extra hands on deck - let us know how much time you would like to dedicate to volunteering and what you are good at. We can use help with Graphic Design, Photography, Social Media, SEO, CV Reviewing, Interview coaching, and tons of other things.  Let's figure out together where you would most like to get active.
`
